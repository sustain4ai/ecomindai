...
async def launchEstimation(input_estimation: InputEstimationLLMInference) -> OutputEstimation:
    """
...
async def launchEstimation(input_estimation: InputEstimationML) -> OutputEstimation:
    """
